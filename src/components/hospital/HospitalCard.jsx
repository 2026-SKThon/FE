...
export default function HospitalCard({ name, distance, first, second }) {
  const [option, setOption] = useState("운영 중");
  return (
    <div className="w-[353px] h-[129px] p-4 bg-white rounded-3xl flex flex-col justify-start items-start gap-2">
